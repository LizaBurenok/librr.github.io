...
openCycle1.onclick = function (){
  ...
  let openCycle3 = document.querySelector('.third_wrap')
  ...
  openCycle3.onclick = function(){
    openText2.classList.toggle('showtexthree')
    hiddentabtwo.style.display = 'none'
    cycletwo.hiddentabone = true
    onefirstStep.classList.toggle('oneFirstStep')
    twofirstStep.classList.toggle('twoFirstStep')
    onesecStep.classList.toggle('oneSecStep')
    twosecStep.classList.toggle('twoSecStep')
  }
  ...
  openCycle4.onclick = function(){
    ...
    hiddentabthree.style.display = 'none'
